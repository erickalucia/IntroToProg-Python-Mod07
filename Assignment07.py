...
#   Ericka Moreno, 11/26/24, Began script
# ------------------------------------------------------------------------------------------ #
import json
...
class Person:
    ...
    def first_name(self,value: str):
        '''
        Sets the first name and checks for only alphabetic characters
        '''
        if value.isalpha():
            self._first_name = value
        else:
            raise ValueError("Please keep your first name as only alphabetic characters")
...
class Student(Person):
    ...
    def __str__(self)->str:
        '''
        Returns first name, last name and course name as string
        :return: student name and course
        '''
...
class FileProcessor:
    ...
    def read_data_from_file(file_name: str, student_data: list[Student])->list[Student]:
        ...
        try:
            ...
            if file is not None and not file.closed == False:
                file.close()
